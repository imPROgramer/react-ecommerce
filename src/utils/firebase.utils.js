...
export const onAuthStateChanged$ = (callback,err,completed)=>onAuthStateChanged(auth , callback,err,completed);

export const addCollectionAndDocuments = async (collectionKey, objectsToAdd)=>{
    const collectionRef = collection(dbFirestore,collectionKey);
    ...
    console.log('Shop data is added');
}

export const getCategoriesAndDocuments= async()=>{
    const collectionRef = collection(dbFirestore,'categories');
